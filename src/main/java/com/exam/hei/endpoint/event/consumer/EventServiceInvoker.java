package com.exam.hei.endpoint.event.consumer;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.exam.hei.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.exam.hei.service.event." + typeNameAsArray[typeNameAsArray.length - 1] + "Service";
  }
